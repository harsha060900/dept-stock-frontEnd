            ...
            <div>
              <h5 className="text-md font-bold">
                ...
                <span className="text-md font-normal">
                  {itemHistory[0].Itemstatus.Itementry.Item.name}
                </span>
              </h5>
            </div>
            <div>
              <h5 className="text-md font-bold">
                Category: &nbsp;
                <span className="text-md font-normal">
                  {itemHistory[0].Itemstatus.Itementry.Item.Category.name}
                </span>
              </h5>
            </div>
            <div>
              <h5 className="text-md font-bold">
                Volume no: &nbsp;
                <span className="text-md font-normal">
                  {itemHistory[0].Itemstatus.Itementry.Ledger.volumeno}
                </span>
              </h5>
            </div>
            <div>
              <h5 className="text-md font-bold">
                Page no: &nbsp;
                <span className="text-md font-normal">
                  {itemHistory[0].Itemstatus.Itementry.Ledger.pageno}
                </span>
              </h5>
            </div>
            <div>
              <h5 className="text-md font-bold">
                S no: &nbsp;
                <span className="text-md font-normal">
                  {itemHistory[0].Itemstatus.Itementry.Ledger.sno}
                </span>
              </h5>
            </div>
            <div>
              <h5 className="text-md font-bold">
                Type: &nbsp;
                <span className="text-md font-normal">
                  {itemHistory[0].Itemstatus.Itementry.Ledger.consumetype}
                </span>
              </h5>
            </div>
          </div>
                    ...
                    {itemHistory.map((itemhis, index) => (
                      ...
                      >
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                          {itemhis.Staff === null ? "---" : itemhis.Staff.regid}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                          {itemhis.Staff === null ? "---" : itemhis.Staff.name}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                          {itemhis.Location === null
                            ? "---"
                            : itemhis.Location.name}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                          {getStatusBadgeInTable(itemhis.paststatus)}
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                          {itemhis.updatedAt.substring(0, 10)}
                        </td>
                      </tr>
                    ))}
                  </tbody>
