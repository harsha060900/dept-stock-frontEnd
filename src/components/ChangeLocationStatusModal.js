...
export default function ChangeLocationStatusModal(props) {
    ...
    useEffect(()=>{
        ...
        if(props.data.Location!=null)
            setLocId(props.data.Location.id)
        else
            setLocId("")
        api.get("/location")
        .then((res)=> {
      ...
      <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" onClose={props.onCloseDetails}>
        <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          ...
          >
            ...
            <h1 className='text-xl text-center mb-4'>Change Status/Location Details</h1>
            <h1 className='text-xl text-center font-bold mb-4'>{props.modalName}</h1>
            {/* {modalData==[]?null:
            ...
            <form className="space-y-8 divide-y divide-gray-200" onSubmit={handleSubmit}>
                    ...
                    <div className="space-y-6 sm:space-y-5">
                        ...
                        <label htmlFor="status" className="block text-lg font-medium text-gray-700 sm:mt-px sm:pt-2">
                            Status
                        </label>
                        ...
                        <label htmlFor="location" className="block text-lg font-medium text-gray-700 sm:mt-px sm:pt-2">
                            Location
                        </label>
                        <div className="mt-1 sm:mt-0 sm:col-span-2">
                            <select
